...
import stat
import sys
from sweety.util.config import load_config, traverse_dict
from sweety.util.permissions import octal_mode_string, verify_file_permissions
...
def check_ssl(root_path: Path) -> None:
    ...
    if len(invalid_files):
        ...
        print("Run `sweety init --fix-ssl-permissions` to fix issues.")
