...
from sweety.util.validate_alert import create_alert_file, create_not_ready_alert_file, validate_alert_file
...
while True:
    hd_path = input("Enter the HD path in the form 'm/12381/10010/n/n', or enter Q to quit: ").lower()
    if hd_path == "q":
        quit()
