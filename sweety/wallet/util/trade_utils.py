...
from sweety.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "sweety" in cc_discrepancies:
                    cc_discrepancies["sweety"] = cc_discrepancies["sweety"] + diff
                else:
                    cc_discrepancies["sweety"] = diff
