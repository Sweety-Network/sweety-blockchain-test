...
address1 = "tsty15gx26ndmacfaqlq8m0yajeggzceu7cvmaz4df0hahkukes695rss6lej7h"  # Gene wallet (m/12381/10010/2/42):
address2 = "tsty1c2cguswhvmdyz9hr3q6hak2h6p9dw4rz82g4707k2xy2sarv705qcce4pn"  # Mariano address (m/12381/10010/2/0)
...
def make_puzzle(amount: int) -> int:
    ...
    if error:
        ...
        for cvp in result_human:
            ...
            total_sweety += int_from_bytes(cvp.vars[1])
            print(
...
total_sweety = 0
print("Pool address: ")
total_sweety += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_sweety += make_puzzle(farmer_amounts)

assert total_sweety == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
