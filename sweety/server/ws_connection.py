...
from sweety.cmds.init_funcs import sweety_full_version_str
from sweety.protocols.protocol_message_types import ProtocolMessageTypes
from sweety.protocols.protocol_state_machine import message_response_ok
from sweety.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from sweety.protocols.shared_protocol import Capability, Handshake
from sweety.server.outbound_message import Message, NodeType, make_msg
from sweety.server.rate_limits import RateLimiter
...
from sweety.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from sweety.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSSweetyConnection:
    """
