...
from sweety.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "510010"
            testnet_introducer = "beta1_introducer.sweety.net"
            testnet_dns_introducer = "dns-introducer-testnet7.sweety.net"
            testnet = "testnet7"
            ...
            mainnet_port = "10010"
            mainnet_introducer = "introducer.sweety.net"
            mainnet_dns_introducer = "dns-introducer.sweety.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running sweety services for changes to take effect")
