...
rm -rf ../venv || true
rm -rf venv || true
rm -rf sweety_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf sweety-blockchain-gui/build || true
rm -rf sweety-blockchain-gui/daemon || true
rm -rf sweety-blockchain-gui/node_modules || true
rm sweety-blockchain-gui/temp.json || true
( cd "$PWD/sweety-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @sweety-network/notarize-cli || true
