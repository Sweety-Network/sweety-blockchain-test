...
from sweety.wallet.puzzles.p2_conditions import puzzle_for_conditions
from sweety.wallet.puzzles import singleton_top_layer
from sweety.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - sweety.pools.pool_puzzles.py
    - sweety.wallet.puzzles.pool_member_innerpuz.clvm
    - sweety.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
