...
from sweety.pools.pool_config import PoolWalletConfig
from sweety.util.config import load_config, save_config, create_default_sweety_config
...
def test_pool_config():
    ...
    create_default_sweety_config(test_root, ["config.yaml"])
