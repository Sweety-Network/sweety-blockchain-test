...
from sweety.server.start_full_node import SERVICE_NAME
...
from sweety.consensus.pot_iterations import calculate_iterations_quality
from sweety.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
