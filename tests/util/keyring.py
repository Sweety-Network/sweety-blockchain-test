...
class TempKeyring:
    def __init__(
        ...
        service: str = "testing-sweety-1.8.0",
        populate: bool = False,
    ...
    def _patch_and_create_keychain(
        ...
        mock_supports_keyring_passphrase_patch = patch("sweety.util.keychain.supports_keyring_passphrase")
        ...
        mock_supports_os_passphrase_storage_patch = patch("sweety.util.keychain.supports_os_passphrase_storage")
