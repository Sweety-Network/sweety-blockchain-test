...
from sweety.full_node.generator import run_generator, create_generator_args
from sweety.full_node.mempool_check_conditions import get_puzzle_and_solution_for_coin
from sweety.types.blockchain_format.program import Program, SerializedProgram, INFINITE_COST
from sweety.types.generator_types import BlockGenerator, CompressorArg, GeneratorArg
...
TEST_GEN_DESERIALIZE = load_clvm("test_generator_deserialize.clvm", package_or_requirement="sweety.wallet.puzzles")
DESERIALIZE_MOD = load_clvm("sweetylisp_deserialisation.clvm", package_or_requirement="sweety.wallet.puzzles")
...
TEST_MULTIPLE = load_clvm("test_multiple_generator_input_arguments.clvm", package_or_requirement="sweety.wallet.puzzles")
