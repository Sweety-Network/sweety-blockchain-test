...
import { Button, CardStep, Select, Flex, Loading } from '@sweety/core';
import {
  Box,
  Grid,
  FormControl,
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent STY farming rewards. The average
    ...
    >
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent STY farming rewards. Create a
