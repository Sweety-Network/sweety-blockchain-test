...
import { CardHero, Flex, Link } from '@sweety/core';
import { PlotHero as PlotHeroIcon } from '@sweety/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Sweety. '
              }
              <Link
                target="_blank"
                href="https://github.com/Sweety-Network/sweety-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
