              ...
              <Flex flexDirection="column" gap={2}>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    paid. By default this will be an STY address, but it can be
                  ...
                  <Link
                    target="_blank"
                    href="https://github.com/Sweety-Network/pool-reference/blob/main/SPECIFICATION.md#payloadpayout_instructions"
                    noWrap
                  >
