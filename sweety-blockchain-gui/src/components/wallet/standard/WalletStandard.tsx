...
import { /* mojo_to_sweety_string, */ sweety_to_mojo } from '../../../util/sweety';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_sweety_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of sweety in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Sweety that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Sweety that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send sweety to coloured address. Please enter a sweety
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'sweety_addr://') {
    ...
    const amountValue = Number.parseFloat(sweety_to_mojo(amount));
    const feeValue = Number.parseFloat(sweety_to_mojo(fee));
