...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@sweety/core';
import {
...
import { mojo_to_sweety_string } from '../../../util/sweety';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_sweety_string(props.balance)} TSTY
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'sweety_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'sweety_addr://') {
