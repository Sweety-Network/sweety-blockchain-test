...
import icon from '../../assets/img/sweety_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Sweety Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Sweety-Network/sweety-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
