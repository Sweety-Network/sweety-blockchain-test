...
import { Link, Table, Card, FormatBytes } from '@sweety/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/Sweety-Network/sweety-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
