...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of sweety', () => {
      const result = units.getUnit('sweety');
    ...
    it('gets unit of sweety using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of sweety', () => {
      const result = units.getDisplay('sweety');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('sweety', 9);

      const result = units.getUnit('sweety');

      expect(result).toEqual(9);

      units.setUnit('sweety', 1);
    });
  });
  describe('#setDisplay', () => {
