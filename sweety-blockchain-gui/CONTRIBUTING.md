...
This repo includes the code for the Sweety GUI in electron/react and TypeScript.

It is an input to the [sweety-blockchain](https://github.com/Sweety-Network/sweety-blockchain) repository which also includes a verifiable delay function implementation that it imports from the [sweetyvdf repo](https://github.com/Sweety-Network/sweetyvdf) (in c/c++), and a proof of space implementation that it imports from the [sweetypos repo](https://github.com/Sweety-Network/sweetypos). BLS signatures are imported from the [bls-signatures repo](https://github.com/Sweety-Network/bls-signatures) as blspy. There is an additional dependency on the [sweetybip158 repo](https://github.com/Sweety-Network/sweetybip158).
For major platforms, binary and source wheels are shipped to PyPI from each dependent repo and then sweety-blockchain can pip install those from PyPI or they can be prepackaged as is done for the Windows and MacOS installer. On unsupported platforms, pip will fall back to the source distributions to be compiled locally.
...
Contact any of the team members on [Keybase](https://keybase.io/team/sweety_network.public), which we use as the main communication method and you can comment on any Trello card.
